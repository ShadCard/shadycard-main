...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="shady-shell w-full min-h-[100dvh] relative pb-20">
      <div className="shady-app-frame mx-auto w-full max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl min-h-[100dvh] shadow-2xl relative overflow-hidden">
