...
- `artifacts/shady-admin/src/components/Crud.tsx`
- `artifacts/shady-admin/src/pages/Products.tsx`
...
```powershell
cd C:\Users\Windows_OS\Desktop\shady-store\lib\db
pnpm run push
```
...
cd C:\Users\Windows_OS\Desktop\shady-store\artifacts\api-server
..\..\node_modules\.bin\tsc.CMD -p tsconfig.json --noEmit
