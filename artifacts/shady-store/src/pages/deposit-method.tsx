...
import { getAuthHeaders } from "@/lib/web-auth";
...
const TELEGRAM_IDENTITY_CACHE_KEY = "shady_telegram_identity";
  ...
  return (
    <div className="min-h-screen bg-background pb-24 animate-in slide-in-from-right-4 duration-300">
      ...
      <div className="p-4 space-y-6 mt-2">
        <div className="p-6 rounded-3xl shady-brand-card border shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-black text-xl text-primary">{getMethodSubtitle(method)}</h2>
            <div className="text-xs px-2 py-1 rounded-full bg-primary/15 text-primary">ShadyCard</div>
          </div>
