...
import { isTelegramMode, logout as webLogout } from "@/lib/web-auth";
        ...
        <div className="bg-card border border-white/5 rounded-3xl overflow-hidden shadow-lg">
          ...
          {!isTelegramMode() && (
            <button
              ...
              className="w-full p-4 flex items-center gap-3 hover:bg-white/5 cursor-pointer transition-colors text-destructive text-right"
            >
